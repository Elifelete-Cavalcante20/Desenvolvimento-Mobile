...
public class MainActivity extends AppCompatActivity {
    ...
    Button busca, exibir, inserir, excluir, excluirValor, pesquisa;
    EditText buscaCep, idParaDeletar, valorPesquisado;
    TextView resultadoBusca, exibeBanco;

    // Variável global para guardar o último JSON de busca retornado pela API.

    private JSONObject ultimoCepJson;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inserir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (ultimoCepJson != null) { // <- valida se a variavel esta vazia antes de iniciar a inserir os dadoss.
                    try {
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String resultado) {
            ...
            try {
                ...
                ult imoCepJson = jsonObject; // <- variavel global para armazenar o resultado de buscas de CEP.
